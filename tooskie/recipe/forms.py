...
class IngredientsForm(forms.Form):
    ...
    unit = forms.ModelChoiceField(required=True, queryset=Unit.objects.order_by('name'))
    ingredient = forms.ModelChoiceField(required=True, label=_('Ingredient'), queryset=Ingredient.objects.order_by('name'))
